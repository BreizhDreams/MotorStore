 ...
 */
final class Version20230509071837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F529939835B1D642 FOREIGN KEY (contain_vo_id) REFERENCES contain (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398D4368D01 FOREIGN KEY (advantage_vo_id) REFERENCES advantage (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
